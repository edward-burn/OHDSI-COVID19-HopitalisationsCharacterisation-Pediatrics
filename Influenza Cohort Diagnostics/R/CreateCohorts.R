...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "InfluenzaHospCohortDiagPeds")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreateInfluenzaPediatrics.csv", package = "InfluenzaHospCohortDiagPeds")
